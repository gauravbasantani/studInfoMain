      ...
      <Form.Check
        ...
        <Form.Check
           ...
           <div className="label">
               ...
               <div>
               <Button variant='outline-dark' className='btn' onClick={setAtLocalStore}>Submit</Button>
               <Button variant='outline-secondary'  className='btn' onClick={getAtLocalStore}>Fetch Data</Button>
